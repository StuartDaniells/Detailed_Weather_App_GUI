...
# get weather report after enter key clicked
...
# WIND label heading
label1 = Label(root, text = "WIND", font=("Helvetica", 15, 'bold'), fg = "white", bg = "#178cc3")
label1.place(x=120, y=400)

# HUMIDITY label heading
label2 = Label(root, text = "HUMIDITY", font=("Helvetica", 15, 'bold'), fg = "white", bg = "#178cc3")
label2.place(x=250, y=400)

# DESCRIPTION label heading
label3 = Label(root, text = "DESCRIPTION", font=("Helvetica", 15, 'bold'), fg = "white", bg = "#178cc3")
label3.place(x=430, y=400)

# PRESSURE label heading
label4 = Label(root, text = "PRESSURE", font=("Helvetica", 15, 'bold'), fg = "white", bg = "#178cc3")
...
w = Label(text = "...", font=("arial", 20, "bold"), bg = "#178cc3")
w.place(x=120, y = 430)

# HUMIDITY label values from api
h = Label(text = "...", font=("arial", 20, "bold"), bg = "#178cc3")
h.place(x=280, y = 430)

# DESCRIPTION label values from api
d = Label(text = "...", font=("arial", 20, "bold"), bg = "#178cc3")
d.place(x=450, y = 430)

# PRESSURE label values from api
p = Label(text = "...", font=("arial", 20, "bold"), bg = "#178cc3")
p.place(x=670, y = 430)
